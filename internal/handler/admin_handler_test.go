...
func TestAdminToggleApproval_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/admin/comments/"+strconv.FormatInt(c.ID, 10)+"/toggle-approval",
...
func TestAdminToggleApproval_WrongPassword(t *testing.T) {
	hash, err := auth.GenerateHash("admin-pass")
	require.NoError(t, err)
...
func TestAdminToggleApproval_NoPasswordConfigured(t *testing.T) {
	db := setupTestDB(t)
	handler := newTestAdminHandler(t, db, "")
...
func TestAdminToggleApproval_NotFound(t *testing.T) {
	...
	body := `{"password":"admin-pass"}`
	req := httptest.NewRequest(http.MethodPost, "/api/v1/admin/comments/99999/toggle-approval",
		strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "99999")
	rec := httptest.NewRecorder()
...
func TestAdminToggleApproval_InvalidID(t *testing.T) {
	...
	body := `{"password":"admin-pass"}`
	req := httptest.NewRequest(http.MethodPost, "/api/v1/admin/comments/abc/toggle-approval",
		strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "abc")
	rec := httptest.NewRecorder()
...
func TestAdminToggleApproval_InvalidJSON(t *testing.T) {
	hash, err := auth.GenerateHash("admin-pass")
	require.NoError(t, err)
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/admin/comments/1/toggle-approval",
...
func TestAdminDelete_Success(t *testing.T) {
	...
	body := `{"password":"admin-pass"}`
	req := httptest.NewRequest(http.MethodDelete, "/api/v1/admin/comments/"+strconv.FormatInt(c.ID, 10),
		strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", strconv.FormatInt(c.ID, 10))
	rec := httptest.NewRecorder()
...
func TestAdminDelete_WrongPassword(t *testing.T) {
	hash, err := auth.GenerateHash("admin-pass")
	require.NoError(t, err)
...
func TestAdminDelete_NoPasswordConfigured(t *testing.T) {
	db := setupTestDB(t)
	handler := newTestAdminHandler(t, db, "")
...
func TestAdminDelete_NotFound(t *testing.T) {
	...
	body := `{"password":"admin-pass"}`
	req := httptest.NewRequest(http.MethodDelete, "/api/v1/admin/comments/99999",
		strings.NewReader(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "99999")
	rec := httptest.NewRecorder()
...
func TestAdminDelete_InvalidJSON(t *testing.T) {
	hash, err := auth.GenerateHash("admin-pass")
	require.NoError(t, err)
	...
	req := httptest.NewRequest(http.MethodDelete, "/api/v1/admin/comments/1",
		strings.NewReader("not json"))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "1")
	rec := httptest.NewRecorder()
